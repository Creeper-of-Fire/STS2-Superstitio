 ...
 * Flavor = ""
 */
public class HaveBirthWith() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 1,
    Type = CardType.Skill,
    Rarity = CardRarity.Common,
 ...
 * Flavor = ""
 */
public class Tease() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 0,
    Type = CardType.Skill,
    Rarity = CardRarity.Uncommon,
 ...
 * Flavor = ""
 */
public class OneMoreHour() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 1,
    Type = CardType.Skill,
    Rarity = CardRarity.Common,
 ...
 * Flavor = ""
 */
public class PassiveGangBang() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 2,
    Type = CardType.Skill,
    Rarity = CardRarity.Rare,
 ...
 * Flavor = ""
 */
public class ReadyToSex() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 0,
    Type = CardType.Skill,
    Rarity = CardRarity.Uncommon,
 ...
 * Flavor = ""
 */
public class RideDildoBike() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 1,
    Type = CardType.Skill,
    Rarity = CardRarity.Uncommon,
 ...
 * Flavor = ""
 */
public class AddSexToy() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 2,
    Type = CardType.Skill,
    Rarity = CardRarity.Uncommon,
 ...
 * Flavor = ""
 */
public class ForceOrgasm() : LupaBaseCard(new CardInitMessage
{
    BaseCost = -1,
    Type = CardType.Skill,
    Rarity = CardRarity.Uncommon,
 ...
 * Flavor = ""
 */
public class ForcePutSexToy() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 1,
    Type = CardType.Skill,
    Rarity = CardRarity.Common,
 ...
 * Flavor = ""
 */
public class TimeStop() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 2,
    Type = CardType.Skill,
    Rarity = CardRarity.Rare,
 ...
 * Flavor = ""
 */
public class Endure() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 1,
    Type = CardType.Skill,
    Rarity = CardRarity.Uncommon,
 ...
 * Flavor = ""
 */
public class EscapeConjuring() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 0,
    Type = CardType.Skill,
    Rarity = CardRarity.Uncommon,
 ...
 * Flavor = ""
 */
public class BecomeTrash() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 2,
    Type = CardType.Skill,
    Rarity = CardRarity.Uncommon,
 ...
 * Flavor = ""
 */
public class GloryHole() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 2,
    Type = CardType.Skill,
    Rarity = CardRarity.Rare,
 ...
 * Flavor = ""
 */
public class MonsterGirlMode() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 2,
    Type = CardType.Power,
    Rarity = CardRarity.Rare,
 ...
 * Flavor = ""
 */
public class ChokeChoker() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 1,
    Type = CardType.Power,
    Rarity = CardRarity.Uncommon,
 ...
 * """
 *
 * Flavor = "只要够烂，裤裆里面什么都可以藏。"
 *
 * Sfw.Title = "秘密武器"
 *
 * Sfw.Flavor = "大榴莲更是给你无数惊喜。"
 */
public class HideInPussy() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 2,
    Type = CardType.Power,
    Rarity = CardRarity.Rare,
 ...
 * """
 *
 * Flavor = "想尝尝看我的屄吗？那就插进来吧。什么？不想？可是你已经插进来了呀。"
 */
public class EroSion() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 1,
    Type = CardType.Attack,
    Rarity = CardRarity.Common,
 ...
 * """
 *
 * Flavor = "全部……全部去掉……让我变成人棍，让我无法逃脱，让我……"
 *
 * Sfw.Title = "义体"
 *
 * Sfw.Flavor = ""
 */
public class FeelPhantomBody() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 0,
 ...
 * Sfw.Flavor = ""
 */
public class GangBang() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 0,
    Type = CardType.Status,
    Rarity = CardRarity.Rare,
 ...
 * Flavor = ""
 */
public class VulnerableTogether() : LupaBaseCard(new CardInitMessage
{
    BaseCost = 0,
    Type = CardType.Skill,
    Rarity = CardRarity.Token,
